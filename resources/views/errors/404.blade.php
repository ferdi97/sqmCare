...
<div class="error">
  ...
  <div class="error__description">Cari apa OOOYYYY kosong page nyaaaa</div>
  <a href="{{route('keterusan')}}">
    <button class="error__button error__button--active">Balik aje</button>
  </a>
